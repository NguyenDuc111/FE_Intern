...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-blue-50">
      ...
      >
        <div className="p-6 text-2xl font-bold bg-white bg-clip-text text-transparent tracking-wide">
          Cholimex Admin
        </div>
      ...
      >
        ...
        <header className="h-16 bg-gradient-to-r from-gray-100 to-blue-50 shadow-md px-6 flex items-center justify-between border-b border-gray-200">
          <h1 className="text-2xl font-semibold bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent">
            Admin Panel
          </h1>
