              ...
              >
                ...
                <td className="px-4 py-3">
                  {u.Role?.RoleName === "admin" ? (
                    <span className="px-3 py-1 text-xs font-semibold text-red-700 bg-red-100 rounded-full shadow-sm">
                      Quản trị viên
                    </span>
                  ) : (
                    <span className="px-3 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full shadow-sm">
                      Người dùng
                    </span>
                  )}
                </td>
